...
export default function Hero() {
    return (
        <div id="hero" className="flex flex-col justify-center items-center min-h-screen tex-center px-4 pt-20">
            ...
            <motion.p className="mt-6 text-xl md:text-2xl max-w-2xl text-gray-300 font-script" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration: 1 }}>I be <span className="font-pirate text-yellow-300">Aryan</span>, a digital buccaneer<br /> crafting treasures with code, pixels & hardware.</motion.p>       
